...
from docdist_dict import (get_words_from_string, count_frequency, vector_an
...
# OUTPUT_FILE is being created that one will then write into this csv file later with all of that data collected
MASTER_FILE = 'Sentences_Table_MasterList_sample.csv'
SENTENCE_DB_FILE = 'Sentence_Database_Without_ID_sample.csv'
# MASTER_FILE & SENTENCE_DB_FILE are both csv files with data in them that will be used to read the data
...
# iterations a value by calling these functions
        if row['SentID_GM'] != 'NA':
